...
/**
 *
 * This is my implementation of send and receive via the JavaMail api (using smtp and pop3)
 * I have also used it in the application server framework as a plugin artfact. It actually makes
 * no sense as it is a utility that can be used without an init and destroy. I have done this
 * just simply to conform to the jndi lookup, which just makes it all convenient.
 * So change it if you dont want to do a contect lookup in the jndi tree to use it. 
 *
 * @author Luigi Zuccarelli
 */

public class MailImpl implements PluginInterface {
